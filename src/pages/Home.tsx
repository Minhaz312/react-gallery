    ...
    const handleOnDrop = (image:ImageItem) => {
        ...
        if (sourceItem !== undefined) {
            if (sourceItem.id === featuredImage.id) {
                ...
                newImageList[imageList.findIndex(p=>p.id===image.id)] = featuredImage
